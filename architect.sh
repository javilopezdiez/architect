...
( arch-chroot /mnt $HOME/architect/architect-setup.sh )|& \
    tee architect-setup.log

echo -ne "--------------------------2- POST-INSTALL PKG STARTED...-------\n"

( arch-chroot /mnt /usr/bin/runuser -u $USERNAME -- /home/$USERNAME/architect/architect-pkg.sh )|& \
